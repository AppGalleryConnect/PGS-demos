     ...
     */
     public playMoveAi(logicManager: LogicManager, dt:number, otherNode:Node, player:Player){
        ...
        if(this._aiPosIndex >= 1){
            ...
            vec_1.set(this._aiPosNode.children[this._nextIndex - 1].position);
            // console.log("c", this._nextIndex, vec_1);
            
            // vec_0.set(
            //     Constant.AI_POS_1[this._nextIndex][0], 
            //     Constant.AI_POS_1[this._nextIndex][1], 
            //     Constant.AI_POS_1[this._nextIndex][2]
            // );
            
            // this._nextIndex ++;
            // if(this._nextIndex >= Constant.AI_POS_1.length){
            //     this._nextIndex = 1;
            // }
