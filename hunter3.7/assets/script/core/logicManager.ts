...
export class LogicManager extends Component {
    ...
    lateUpdate(dt: number): void {
        ...
        this.currentGameState.time = Math.floor(Constant.GAME_TIME - (frameTime - this._startGameTime + GobeUtil.instance.serverTimeDis) / 1000);
        ...
        if (this.currentGameState.createHammerTime === 0) {
            this.currentGameState.createHammerTime = frameTime + Constant.HAMMER_TIME * 1000;
        }
